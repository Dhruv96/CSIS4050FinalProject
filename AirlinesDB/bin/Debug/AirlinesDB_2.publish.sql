...
GO
PRINT N'Creating [dbo].[FK_BOOKING]...';


GO
ALTER TABLE [dbo].[Booking]
    ADD CONSTRAINT [FK_BOOKING] FOREIGN KEY ([FlightId]) REFERENCES [dbo].[Flight] ([FlightId]) ON DELETE CASCADE ON UPDATE CASCADE;
