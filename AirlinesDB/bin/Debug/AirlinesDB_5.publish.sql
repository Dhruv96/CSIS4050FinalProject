...
CREATE TABLE [dbo].[FlightBooking] (
    ...
    CONSTRAINT [PK_FLIGHTBOOKING] PRIMARY KEY CLUSTERED ([BookingId] ASC, [PassengerId] ASC, [FlightId] ASC, [SeatNum] ASC)
);
...
CREATE TABLE [dbo].[Seat] (
    ...
    CONSTRAINT [PK_SEAT] PRIMARY KEY CLUSTERED ([FlightId] ASC, [SeatNum] ASC)
);
...
GO
ALTER TABLE [dbo].[FlightBooking]
    ADD CONSTRAINT [FK_FLIGHTBOOKING_SNUM] FOREIGN KEY ([FlightId], [SeatNum]) REFERENCES [dbo].[Seat] ([FlightId], [SeatNum]);
